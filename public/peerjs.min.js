!(function () {
      ...
      (function (e, t) {
        if (e) {
          ...
          return (
            ...
            "Map" === r || "Set" === r ? Array.from(r) : "Arguments" === r || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(r) ? a(e, t) : void 0
          );
        }
      })(e, t) ||
      (function () {
  ...
  function _(e) {
    return "boolean" != typeof e
      ? new Error("Argument type: " + (void 0 === e ? "undefined" : c(e)) + ". Please use a boolean.")
      : ((y = e), e ? "adapter.js logging disabled" : "adapter.js logging enabled");
  }
  function S(e) {
    return "boolean" != typeof e
      ? new Error("Argument type: " + (void 0 === e ? "undefined" : c(e)) + ". Please use a boolean.")
      : ((g = !e), "adapter.js deprecation warnings " + (e ? "disabled" : "enabled"));
  }
  function T() {
  ...
  function w(e) {
    ...
    else if (r.webkitGetUserMedia || (!1 === e.isSecureContext && e.webkitRTCPeerConnection && !e.RTCIceGatherer))
      (t.browser = "chrome"), (t.version = b(r.userAgent, /Chrom(e|ium)\/(\d+)\./, 2));
      ...
      var n = function (e) {
              ...
              if ("require" !== r && "advanced" !== r && "mediaSource" !== r) {
                ...
                if (void 0 !== n.ideal) {
                  ...
                  "number" == typeof n.ideal
                    ? ((o[i("min", r)] = n.ideal), t.optional.push(o), ((o = {})[i("max", r)] = n.ideal), t.optional.push(o))
        ...
        i = function (e, i) {
          ...
          if ((e = JSON.parse(JSON.stringify(e))) && "object" == typeof e.audio) {
            ...
            o((e = JSON.parse(JSON.stringify(e))).audio, "autoGainControl", "googAutoGainControl"),
          ...
          if (e && "object" == typeof e.video) {
            ...
            if (
              a &&
              ("user" === a.exact || "environment" === a.exact || "user" === a.ideal || "environment" === a.ideal) &&
              (!r.mediaDevices.getSupportedConstraints || !r.mediaDevices.getSupportedConstraints().facingMode || c)
            )
              if (
      ...
      e.RTCPeerConnection &&
        ...
        ["setLocalDescription", "setRemoteDescription", "addIceCandidate"].forEach(function (t) {
          var r = e.RTCPeerConnection.prototype[t],
            n = o({}, t, function () {
              return (
                (arguments[0] = new ("addIceCandidate" === t ? e.RTCIceCandidate : e.RTCSessionDescription)(arguments[0])), r.apply(this, arguments)
              );
            });
  ...
  function X(e, t) {
    ...
    return (
      (r.name = e),
      (r.code = { NotSupportedError: 9, InvalidStateError: 11, InvalidAccessError: 15, TypeError: void 0, OperationError: void 0 }[e]),
      r
    );
  }
  function Z(e) {
    ...
    t.RTCRtpSender &&
      ...
      Object.defineProperty(t.RTCRtpSender.prototype, "dtmf", {
        get: function () {
          return (
            void 0 === this._dtmf &&
              ("audio" === this.track.kind ? (this._dtmf = new t.RTCDtmfSender(this)) : "video" === this.track.kind && (this._dtmf = null)),
            this._dtmf
          );
        },
      }),
  ...
  (H.generateIdentifier = function () {
    ...
    (H.writeCryptoLine = function (e) {
      return (
        ...
        e.cryptoSuite +
        " " +
        ("object" == typeof e.keyParams ? H.writeCryptoKeyParams(e.keyParams) : e.keyParams) +
      ...
      for (var t = { codecs: [], headerExtensions: [], fecMechanisms: [], rtcp: [] }, r = H.splitLines(e)[0].split(" "), n = 3; n < r.length; n++) {
        ...
        if (o) {
          ...
          switch (
            ...
            (a.rtcpFeedback = H.matchPrefix(e, "a=rtcp-fb:" + i + " ").map(H.parseRtcpFb)),
            t.codecs.push(a),
            a.name.toUpperCase())
          ) {
            case "RED":
      ...
      c.length > 0 && c[0].length > 1 && c[0][0] === s && (t = c[0][1]),
        n.codecs.forEach(function (e) {
          if ("RTX" === e.name.toUpperCase() && e.parameters.apt) {
            ...
            s && t && (n.rtx = { ssrc: t }),
              r.push(n),
              i && (((n = JSON.parse(JSON.stringify(n))).fec = { ssrc: s, mechanism: o ? "red+ulpfec" : "red" }), r.push(n));
          }
        }),
    ...
    (J = function (e, t) {
        ...
        i = function (r) {
          ...
          if (
            ...
            for (var o = r.iceCandidatePoolSize; o > 0; o--)
              this._iceGatherers.push(new e.RTCIceGatherer({ iceServers: r.iceServers, gatherPolicy: r.iceTransportPolicy }));
      ...
      Object.defineProperty(i.prototype, "localDescription", {
        ...
        (i.prototype.setLocalDescription = function (e) {
          ...
          if (!q("setLocalDescription", e.type, n.signalingState) || n._isClosed)
            return Promise.reject(X("InvalidStateError", "Can not set local " + e.type + " in state " + n.signalingState));
          if ("offer" === e.type)
            ...
            t.forEach(function (e, t) {
              ...
              if (!(W.isRejected(e) && 0 === W.matchPrefix(e, "a=bundle-only").length) && !o.rejected) {
                ...
                i && (l.role = "server"),
                  (n.usingBundle && 0 !== t) ||
                    (n._gather(o.mid, t), "new" === s.state && s.start(a, u, i ? "controlling" : "controlled"), "new" === c.state && c.start(l));
                var f = Y(p, d);
          ...
          return (
            ...
            "offer" === e.type ? n._updateSignalingState("have-local-offer") : n._updateSignalingState("stable"),
            Promise.resolve()
          );
        }),
        (i.prototype.setRemoteDescription = function (i) {
          ...
          if (!q("setRemoteDescription", i.type, o.signalingState) || o._isClosed)
            return Promise.reject(X("InvalidStateError", "Can not set remote " + i.type + " in state " + o.signalingState));
          var a = {};
          ...
          return (
            ...
            c.forEach(function (n, c) {
              ...
              if (h || ("application" === f && ("DTLS/SCTP" === m || "UDP/DTLS/SCTP" === m)))
                o.transceivers[c] = { mid: g, kind: f, protocol: m, rejected: !0 };
              else {
        ...
        (i.prototype.createAnswer = function () {
          ...
          if ("have-remote-offer" !== r.signalingState && "have-local-pranswer" !== r.signalingState)
            return Promise.reject(X("InvalidStateError", "Can not call createAnswer in signalingState " + r.signalingState));
          ...
          return e && void 0 === e.sdpMLineIndex && !e.sdpMid
            ...
            : new Promise(function (n, i) {
                ...
                if (e && "" !== e.candidate) {
                  ...
                  if ((0 === o || (o > 0 && s.iceTransport !== r.transceivers[0].iceTransport)) && !Q(s.iceTransport, c))
      ...
      if (n && n.prototype.applyConstraints) {
        ...
        n.prototype.applyConstraints = function (e) {
          return (
            "audio" === this.kind &&
              "object" == typeof e &&
              ((e = JSON.parse(JSON.stringify(e))), i(e, "autoGainControl", "mozAutoGainControl"), i(e, "noiseSuppression", "mozNoiseSuppression")),
            s.apply(this, [e])
          );
        };
      }
        ...
        if (e && e.iceServers) {
          for (var n = [], i = 0; i < e.iceServers.length; i++) {
            ...
            !o.hasOwnProperty("urls") && o.hasOwnProperty("url")
              ? (k("RTCIceServer.url", "RTCIceServer.urls"), ((o = JSON.parse(JSON.stringify(o))).urls = o.url), delete o.url, n.push(o))
      ...
      (t.RTCIceCandidate = function (t) {
        if (
          ("object" == typeof t &&
            ...
            ((t = JSON.parse(JSON.stringify(t))).candidate = t.candidate.substr(2)),
    ...
    if (t.RTCPeerConnection) {
      ...
      var n = function (t) {
        ...
        o = function (e) {
          ...
          return (
            "firefox" === r.browser &&
              (t = r.version < 57 ? (-1 === e ? 16384 : 2147483637) : r.version < 60 ? (57 === r.version ? 65535 : 65536) : 2147483637),
            t
          );
        },
        a = function (t, n) {
    ...
    at =
      ...
      (et.prototype._print = function (e) {
        ...
        e >= Qe.All
          ...
          : e >= Qe.Errors && console.error.apply(console, Ze(["ERROR"], Xe(n), !1));
      }),
      et),
    st = new at(),
    ct = {};
    ...
    mt = (function (e) {
      ...
      return (
        ...
        (t.prototype._cleanup = function () {
          this._socket &&
            ((this._socket.onopen = this._socket.onmessage = this._socket.onclose = null), this._socket.close(), (this._socket = void 0)),
      ...
      var r,
        ...
        s = function (o) {
          ...
          for (; c; )
            try {
              if (
                ((r = 1), n && (i = 2 & o[0] ? n.return : o[0] ? n.throw || ((i = n.return) && i.call(n), 0) : n.next) && !(i = i.call(n, o[1])).done)
              )
                return i;
      ...
      return (
        (e.prototype.startConnection = function (e) {
          ...
          if (
            ...
            this.connection.type === tt.Media && e._stream && this._addTracksToConnection(e._stream, t),
            e.originator)
          ) {
        ...
        (e.prototype._setupListeners = function (e) {
          ...
          qe.default.log("Listening for ICE candidates."),
            (e.onicecandidate = function (e) {
              e.candidate &&
                e.candidate.candidate &&
                (qe.default.log("Received ICE candidates for ".concat(r, ":"), e.candidate),
                o.socket.send({ type: ot.Candidate, payload: { candidate: e.candidate, type: i, connectionId: n }, dst: r }));
            }),
            (e.oniceconnectionstatechange = function () {
              switch (e.iceConnectionState) {
                case "failed":
                  qe.default.log("iceConnectionState is failed, closing connections to " + r),
                    t.connection.emit("error", new Error("Negotiation of connection to " + r + " failed.")),
                    t.connection.close();
                  break;
                case "closed":
                  qe.default.log("iceConnectionState is closed, closing connections to " + r),
                    t.connection.emit("error", new Error("Connection to " + r + " closed.")),
                    t.connection.close();
                  break;
                case "disconnected":
                ...
                case 4:
                  return (
                    ...
                    this.connection.type === tt.Data &&
                      ((i = this.connection), (n = gt(gt({}, n), { label: i.label, reliable: i.reliable, serialization: i.serialization }))),
                    t.socket.send({ type: ot.Offer, payload: n, dst: this.connection.peer }),
                    [3, 6]
                  );
                case 5:
                  return (
                    "OperationError: Failed to set local offer sdp: Called in wrong state: kHaveRemoteOffer" != (o = s.sent()) &&
                      (t.emitError(rt.WebRTC, o), qe.default.log("Failed to setLocalDescription, ", o)),
                    [3, 6]
                  );
                case 6:
                  return [3, 8];
              ...
              switch (o.label) {
                ...
                case 4:
                  return (
                    ...
                    t.socket.send({
                      type: ot.Answer,
                      payload: { sdp: r, type: this.connection.type, connectionId: this.connection.connectionId, browser: Fe.browser },
            ...
            return Ct(this, function (a) {
              switch (a.label) {
                ...
                case 2:
                  return (
                    a.sent(),
                    qe.default.log("Set remoteDescription:".concat(e, " for:").concat(this.connection.peer)),
        ...
        (e.prototype._addTracksToConnection = function (e, t) {
          if ((qe.default.log("add tracks from stream ".concat(e.id, " to peer connection")), !t.addTrack))
            return qe.default.error("Your browser does't support RTCPeerConnection#addTrack. Ignored.");
      ...
      return (
        ...
        (t.prototype.answer = function (e, t) {
          ...
          if ((void 0 === t && (t = {}), this._localStream))
            qe.default.warn("Local stream already exists on this MediaConnection. Are you answering a call twice?");
          else {
            (this._localStream = e),
              t && t.sdpTransform && (this.options.sdpTransform = t.sdpTransform),
              this._negotiator.startConnection(Pt(Pt({}, this.options._payload), { _stream: e }));
      ...
      return (
        ...
        (t.prototype.close = function () {
          (this._buffer = []),
            ...
            this.provider && (this.provider._removeConnection(this), (this.provider = null)),
            this.dataChannel &&
              ((this.dataChannel.onopen = null), (this.dataChannel.onmessage = null), (this.dataChannel.onclose = null), (this._dc = null)),
          ...
          return Bt(this, void 0, Promise, function () {
            ...
            return Nt(this, function (n) {
              switch (n.label) {
                ...
                case 2:
                  throw (
                    ((r = n.sent()), qe.default.error("Error retrieving list peers", r), new Error("Could not get list peers from the server." + r))
                  );
                case 3:
                  return [2];
              }
    ...
    Jt = (function (e) {
      function t(r, n) {
        ...
        return (
          ...
          o._options.path &&
            ("/" !== o._options.path[0] && (o._options.path = "/" + o._options.path),
            "/" !== o._options.path[o._options.path.length - 1] && (o._options.path += "/")),
      ...
      return (
        ...
        (t.prototype._handleMessage = function (e) {
          ...
          switch (n) {
            ...
            case ot.Offer:
              ...
              if (
                ((f = this.getConnection(o, a)) && (f.close(), qe.default.warn("Offer received for existing Connection ID:".concat(a))),
                i.type === tt.Media)
              ) {
        ...
        (t.prototype._addConnection = function (e, t) {
          qe.default.log("add connection ".concat(t.type, ":").concat(t.connectionId, " to peerId:").concat(e)),
        ...
        (t.prototype.destroy = function () {
          this.destroyed ||
            (qe.default.log("Destroy peer with ID:".concat(this.id)), this.disconnect(), this._cleanup(), (this._destroyed = !0), this.emit("close"));
        }),
        (t.prototype._cleanup = function () {
          var e, t;
          try {
        ...
        (t.prototype.reconnect = function () {
          if (this.disconnected && !this.destroyed)
            qe.default.log("Attempting reconnection to server with ID ".concat(this._lastServerId)),
              (this._disconnected = !1),
